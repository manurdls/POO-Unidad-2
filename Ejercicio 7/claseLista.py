...
class Lista(object):
    ...
    def consultar_millas(self, num_viajero):
        ...
        if indice_viajero != None:
            print("Nombre viajero frecuente: {}, Millas Acumuladas: {}".format(self.__viajeros[indice_viajero],
                                                                               self.__viajeros[indice_viajero].cantidadTotalMillas()))

    def acumular_millas(self, num_viajero, millas_recorridas):
        indice_viajero = self._buscar_viajero_por_num_viajero(num_viajero)
        if indice_viajero != None:
            self.__viajeros[indice_viajero] = millas_recorridas + self.__viajeros[indice_viajero]
            print("Nombre viajero frecuente: {}, Millas Acumuladas: {}".format(self.__viajeros[indice_viajero],
                                                                               self.__viajeros[indice_viajero].cantidadTotalMillas()))
    ...
    def canjear_millas(self, num_viajero, millas_a_canjear):
        indice_viajero = self._buscar_viajero_por_num_viajero(num_viajero)
        if indice_viajero != None:
            self.__viajeros[indice_viajero] = millas_a_canjear - self.__viajeros[indice_viajero]
            print("Nombre viajero frecuente: {}, Millas Acumuladas: {}".format(self.__viajeros[indice_viajero],
                                                                               self.__viajeros[indice_viajero].cantidadTotalMillas()))
    ...
    def comparar_millas_acumuladas_con_un_entero_izq(self, num_viajero, entero):
        indice_viajero = self._buscar_viajero_por_num_viajero(num_viajero)
        if indice_viajero != None:
            if self.__viajeros[indice_viajero] == entero:
                print('El viajero efectivamente posee las millas que ud ingresó por teclado')
            else:
                print('El viajero no posee las millas que ud ingresó por teclado.')
            print("Nombre viajero frecuente: {}, Millas Acumuladas: {}".format(self.__viajeros[indice_viajero],
                                                                               self.__viajeros[indice_viajero].cantidadTotalMillas()))

    def comparar_millas_acumuladas_con_un_entero_der(self, num_viajero, entero):
        indice_viajero = self._buscar_viajero_por_num_viajero(num_viajero)
        if indice_viajero != None:
            if entero == self.__viajeros[indice_viajero]:
                print('El viajero efectivamente posee las millas que ud ingresó por teclado')
            else:
                print('El viajero no posee las millas que ud ingresó por teclado.')
            print("Nombre viajero frecuente: {}, Millas Acumuladas: {}".format(self.__viajeros[indice_viajero],
